// **************************************************
// WEB524 Project Template V3 == d4e4da75-3334-4e64-90fb-fca0340b8dda
    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<Artist, ArtistWithAlbumsViewModel>();
        ...
        //public IEnumerable<ArtistWithAlbumsViewModel> ArtistGetAllWithAlbums()
        //{
        //    var o = ds.Artists.Include("Albums");

        //    return mapper.Map<IEnumerable<Artist>, IEnumerable<ArtistWithAlbumsViewModel>>(o.OrderBy(b => b.Name));
        //}
        ...
        {
            var o = ds.Artists.Include("ArtistMediaItems").SingleOrDefault(a => a.Id == id);
            return o == null ? null : mapper.Map<Artist, ArtistWithMediaInfoViewModel>(o);
        }

        public ArtistWithAlbumsViewModel ArtistGetByIdWithAlbums(int id)
        {
            var o = ds.Artists.Include("Albums").SingleOrDefault(a => a.Id == id);
            return mapper.Map<Artist, ArtistWithAlbumsViewModel>(o);
            //return mapper.Map<Artist, ArtistWithMediaInfo>(o);
        }
        ...
        public IEnumerable<AlbumWithDetailsViewModel> AlbumGetAllWithDetail()
        {
            var o = ds.Albums.Include("Artists").Include("Tracks");
            return mapper.Map<IEnumerable<Album>, IEnumerable<AlbumWithDetailsViewModel>>(o.OrderByDescending(a => a.ReleaseDate));
        }

        public AlbumBaseViewModel AlbumGetById(int id)
        {
            var o = ds.Albums.Find(id);
            return (o == null) ? null : mapper.Map<Album, AlbumBaseViewModel>(o);
        }
        ...
        public IEnumerable<TrackBaseViewModel> TrackGetAll()
        {
            ...
            return mapper.Map<IEnumerable<Track>, IEnumerable<TrackBaseViewModel>>(o.OrderBy(t => t.Name));
        }
        ...
        public TrackAudioViewModel TrackGetByIdWithAudio(int id)
        {
            var o = ds.Tracks.Find(id);
        ...
        public TrackBaseViewModel TrackAdd(TrackAddViewModel newItem)
        {
        ...
        public TrackBaseViewModel TrackEdit(TrackEditViewModel newItem)
        {
            // Attempt to fetch the object to be updated
            var itemToUpdate = ds.Tracks.Find(newItem.Id);
            ...
            else
            {
                ...
                byte[] audioBytes = new byte[newItem.AudioUpload.ContentLength];
                newItem.AudioUpload.InputStream.Read(audioBytes, 0, newItem.AudioUpload.ContentLength);
                itemToUpdate.Audio = audioBytes;
                itemToUpdate.AudioContentType = newItem.AudioUpload.ContentType;

                ds.SaveChanges();

                return mapper.Map<Track, TrackBaseViewModel>(itemToUpdate);
            }
        }
        ...
        {
            var o = ds.ArtistMediaItems.SingleOrDefault(a => a.StringId == stringId);
            return o == null ? null : mapper.Map<ArtistMediaItem, ArtistMediaItemContentViewModel>(o);
        }

        public ArtistWithMediaInfoViewModel ArtistMediaItemAdd(ArtistMediaItemAddViewModel newItem)
        {
            ...
            {
                var addedItem = ds.ArtistMediaItems.Add(mapper.Map<ArtistMediaItemAddViewModel, ArtistMediaItem>(newItem));
                addedItem.Artist = artist;

                byte[] artistMediaItemBytes = new byte[newItem.MediaUpload.ContentLength];
                newItem.MediaUpload.InputStream.Read(artistMediaItemBytes, 0, newItem.MediaUpload.ContentLength);
                addedItem.Content = artistMediaItemBytes;
                addedItem.ContentType = newItem.MediaUpload.ContentType;

                ds.SaveChanges();

                return addedItem == null ? null : mapper.Map<Artist, ArtistWithMediaInfoViewModel>(artist);
            }
        }
